												...
												<div class="pt-dtable">
													<div class="pt-vmiddle">
														...
														<div class="pt-options">
															...
															<a class="pt-reduce"><?="₹".$item_rs['reduce_price']?></a>
															<?php endif; ?>
															<?php if ($rs['neworders']): ?>
															<div class="pt-addtocart" data-id="<?=$item_rs['id']?>">
																...
																<a data-toggle="modal" href="#addtocartModal" class="pt-price"><?="₹".$item_rs['selling_price']?></a>
															</div>
															<?php else: ?>
																<a class="pt-reduce text-success"><?="₹".$item_rs['selling_price']?></a>
															<?php endif; ?>
														</div>
													</div>
												</div>
