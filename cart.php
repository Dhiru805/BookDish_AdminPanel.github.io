						...
						<div class="pt-dtable">
							<div class="pt-vmiddle">
								...
								<div class="pt-extra">
									...
									<?php endif; ?>
									<strong>Price: <a class="checked"><?="₹".($item_size ? $item_size['price'] : $rs['selling_price'])?></a></strong>
								</div>
								<div class="pt-extra">
									<?php
									if($cart['item_extra']):
			...
			<div class="pt-cart-body">
		      ...
		      <form id="payment-form" method="POST" action="stripe.php">
						...
						<div class="fieldset mb-4">
							<p class="mt-2"><span><?=$lang['cart']['subtotal']?></span><b class="float-right pt-totalprice">₹0.00</b></p>
							<p><span><?=$lang['cart']['shipping_fees']?></span><b class="float-right pt-deliverytotalprice">₹0.00</b></p>
							<hr />
							<p><span><?=$lang['cart']['total']?></span><b class="float-right pt-alltotalprice">₹0.00</b></p>
						</div>
