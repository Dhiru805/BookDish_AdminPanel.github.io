...
<div class="media">
	<div class="media-left">
		...
		<div class="media-body">
			...
			<span class="pt-ingredient"><i class="fas fa-utensils"></i> <b>Ingredient:</b> <?=$item_rs['ingredients']?></span>
			<textarea name="item_note" placeholder="Your extra note"></textarea>
		</div>
</div>
<div class="pt-price-det">
	<div class="pt-price pt-totalprice"><?="₹".$item_rs['selling_price']?></div>
	<?php if($item_rs['reduce_price'] && $item_rs['reduce_price'] != $item_rs['selling_price']): ?>
	<div class="pt-reduce"><?="₹".$item_rs['reduce_price']?></div>
	<?php endif; ?>
	<button type="button" class="pt-btn pt-buytocart" data-buy="false">Add to cart</button>
	<button type="submit" class="pt-buy" data-buy="true">Buy now</button>
</div>
