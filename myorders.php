				...
				<div class="media-body">
					<div class="pt-dtable">
						<div class="pt-vmiddle">
							...
							<div class="pt-extra">
								<strong><i class="fas fa-money-bill-wave"></i> <?=$cart['item_quantities']?> x <a><?="₹".($item_size ? $item_size['price'] : $rsi['selling_price'])?></a></strong>
							...
							<div class="pt-extra">
								...
								?>
									<span><?=$extra['name']?> <b class="pt-extraprice"><?="₹".$extra['price']?></b></span>
								<?php
								endforeach;
								endif;
								?>
