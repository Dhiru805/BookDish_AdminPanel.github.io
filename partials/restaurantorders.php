		...
		<div class="media-body">
			<div class="pt-dtable">
				<div class="pt-vmiddle">
					...
					<div class="pt-extra">
						<strong class="mr-2"><i class="fas fa-money-bill-wave"></i> <?=$cart['item_quantities']?> x <a><?="₹".(isset($cart['item_price']) ? $cart['item_price'] : ($item_size ? $item_size['price'] : $rsi['selling_price']))?></a></strong>
			...
			<table class="table border">
				...
				<tbody>
					<tr>
						...
						<td class="text-center"><?="₹".(isset($cart['item_price']) ? $cart['item_price'] : ($item_size ? $item_size['price'] : $rsi['selling_price']))?></td>
						<td class="text-center"><?="₹".(isset($cart['item_delivery']) ? $cart['item_delivery'] : 0)?></td>
						...
						<td class="text-center"><?="₹".($tttot*$cart['item_quantities'])?></td>
					</tr>
					<?php
					...
					<tr>
						...
						<td class="text-center"><?=$cart['item_quantities']?></td>
						<td class="text-center"><?php echo "₹".$extra['price']; ?></td>
						<td class="text-center">--</td>
						<td class="text-center"><?php echo "₹".($extra['price']*$cart['item_quantities']); ?></td>
					</tr>
					<?php
					endforeach;
					endif;
