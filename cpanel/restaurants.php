				...
				<div class="tab-content">
					<div class="tab-pane active container" id="home">
						...
						<div class="form-group">
							...
							<div class="pt-phone">
								<div class="pt-flags">
									<select class="selectpicker" data-live-search="true" data-width="100%" name="phone_code" disabled>
									<option data-icon="flag-icon flag-icon-in" data-tokens="IN India" value="IN"<?=(($c['code'] == 'IN') ? ' selected' : '')?>>(+91)</option>
									</select>
								</div>
						...
						<div class="row">
							<div class="col-4">
								<div class="form-group">
									...
									<select class="selectpicker" disabled data-live-search="true" data-width="100%" name="country" title="<?=$lang['cart']['']?>">
											<option data-tokens="IN India" value="India"<?=($rs && $k == $rs['India'] ? 'selected' : '')?>><?=$c?>India</option>
									</select>
								</div>
							</div>
							<div class="col-4">
