				...
				<div class="media-body">
					<div class="pt-dtable">
						<div class="pt-vmiddle">
							...
							<div class="pt-extra">
								<strong><i class="fas fa-money-bill-wave"></i> <?=$cart['item_quantities']?> x <a><?="₹".(isset($cart['item_price']) ? $cart['item_price'] : ($item_size ? $item_size['price'] : $rsi['selling_price']))?></a></strong>
					...
					<table class="table border float-right w-25">
						<tbody>
							<tr>
								...
								<td class="right"><?php echo "₹".$toott; ?></td>
							</tr>
							<tr>
							...
							<tr>
								...
								<td class="right"><strong><?php echo "₹".($toott+$tshipp); ?></strong></td>
							</tr>
						</tbody>
					</table>
				</div>
