<div class="pt-footer">
	<div class="container">
		<div class="row">
			<div class="col-3">
				<div class="pt-logo">
					<a href="#"><i class="fas fa-hamburger"></i> BookDish</a>
				</div>
				<div class="pt-social">
			...
			<div class="col-3">
				<div class="pt-copy">
					...
					Copyright &copy; 2020 <a href="<?= path ?>">BookDish</a>. All Rights Reserved.
					Programming and design with by <a target="_blank" href="http://www.metrotouch.in/">MetroTouch</a>.
				</div>
			</div>
		</div>
	</div>
		...
		<div class="modal fade newmodal" id="testimonialModal">
			<div class="modal-dialog">
				<div class="modal-content">
					...
					<?php else : ?>
						<div class="modal-body">
							<p class="bg-light text-dark p-3"><?php echo $rs_testimonial['content'] ?></p>
						</div>
					<?php endif; ?>
				</div>
			</div>
